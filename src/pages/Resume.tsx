...
export default function Resume() {
    return (
        <>
            ...
            <Header />
            <div className="container px-4 mx-auto text-primary flex flex-col gap-8 max-w-6xl text-xl mb-8">
                <Education />
...
const Header = () => (
    <div className="text-center self-center text-secondary font-semibold p-4 flex justify-center mx-auto max-w-6xl text-xl">
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-16">
            ...
            <div className="right-col">
                <div><a href="mailto: email@joelmiles.com">email@joelmiles.com</a></div>
                <div className="links">
                    <a href="https://github.com/Neeblue" target="_blank" className="mr-4">
                        ...
                        Github</a>
                    <a href="https://www.linkedin.com/in/jmrmiles/" target="_blank"><svg
