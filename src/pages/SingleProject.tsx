...
export default function SingleProject(){
    ...
    usePreloadImages(project?.detailsImage || []);
                ...
                <div key={index} className='section max-w-full justify-center flex flex-col gap-4 mb-8 sm:flex-row sm:items-center'>
                    {isMobile ? (
                        <>
                            ...
                            <img className='detailsImage' src={project.detailsImage[index]} alt="" style={{ aspectRatio: '16/9', width: '100%', maxWidth: isMobile ? undefined : '50vw', maxHeight: isMobile ? undefined : '60vw' }} />
                        ...
                        <>
                            {index % 2 === 0 ? (
                                <>
                                    <img className='detailsImage max-w-[50vw] max-h-[60vw] p-2 object-contain' src={project.detailsImage[index]} alt= "" style={{ aspectRatio: '16/9', width: '100%', maxWidth: '50vw', maxHeight: '60vw' }} />
